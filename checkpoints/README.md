...
| File                           | Backbone           | Trained on            | mga AUC (Open-Source) |
| ------------------------------ | ------------------ | --------------------- | --------------------: |
| `pvp_heads/timesformer_k400_vpvp.pt` | TimeSformer-Base K400 | AIGVDBench Open-Sora |              0.9124   |
| `pvp_heads/uniformerv2_k400_vpvp.pt` | UniFormerV2-Base K400 | AIGVDBench Open-Sora |              0.9356   |
| `pvp_heads/videomae_k400_vpvp.pt`    | VideoMAE-Base K400    | AIGVDBench Open-Sora |              0.9528   |
| `pvp_heads/qwen3vl_8b_vpvp.pt`       | Qwen3-VL-8B (vision)  | AIGVDBench Open-Sora |              0.9778   |
